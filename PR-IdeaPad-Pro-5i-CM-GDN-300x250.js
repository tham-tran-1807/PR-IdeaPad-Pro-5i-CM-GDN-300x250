...
lib.ssMetadata = [
		{name:"PR_IdeaPad_Pro_5i_CM_GDN_300x250_atlas_1", frames: [[604,0,50,50],[0,0,300,250],[0,252,300,250],[0,504,300,250],[0,756,300,250],[302,0,300,250],[302,252,300,250],[302,504,300,250],[302,756,300,250]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_IdeaPad_Pro_5i_CM_GDN_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaPadPro5iCMGDN300x250 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(363).call(this.frame_363).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(362).to({_off:false},0).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(350).to({_off:false},0).to({x:10.35,y:11},12).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(350).to({_off:false},0).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({_off:true},50).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(250).to({_off:false},0).to({_off:true},50).wait(70));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(200).to({_off:false},0).to({_off:true},50).wait(120));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(150).to({_off:false},0).to({_off:true},50).wait(170));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(100).to({_off:false},0).to({_off:true},50).wait(220));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(50).to({_off:false},0).to({_off:true},50).wait(270));

	// Layer_1
	this.instance_7 = new lib.Frame1();
	this.instance_7.setTransform(0,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true},50).wait(320));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(150,106.3,150,144.7);
// library properties:
lib.properties = {
	id: '100B8CC1E6B86A4EABB7355FA96C4914',
	width: 300,
	height: 250,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_IdeaPad_Pro_5i_CM_GDN_300x250_atlas_1.png", id:"PR_IdeaPad_Pro_5i_CM_GDN_300x250_atlas_1"}
	],
	preloads: []
};
...
an.compositions['100B8CC1E6B86A4EABB7355FA96C4914'] = {
